...
// Over the cloud a command's reply is often lost: wait this long for it, then
// up to CLOUD_CONFIRM_TIMEOUT_MS for the robot's status to show the result.
const CLOUD_REPLY_TIMEOUT_MS = 8000;
const CLOUD_CONFIRM_TIMEOUT_MS = 20000;
