...
class NarwalBinaryProtocol {
  ...
  normalizeBaseStatus(decoded = {}) {
    ...
    // Field 47 = 2 means off the dock on old and new firmware. Newer Flow 2
    // firmware (v01.09.10.02) reports working status 2 while cleaning away
    // from the dock; older firmware used 2 for docked.
    if (workingStatus === WORKING_STATE.DOCKED_V2 && dockField47 === 2 && state === C.RobotState.DOCKED) {
